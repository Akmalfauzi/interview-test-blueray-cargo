                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 422) {
                                ...
                                $registerErrors.append('<li>Terlalu banyak percobaan registrasi. Silakan coba lagi dalam 1 menit.</li>');
                            } else {
                                // Handle other errors
                                $registerErrors.append('<li>' + (response.message || 'An error occurred during registration') + '</li>');
                            }
